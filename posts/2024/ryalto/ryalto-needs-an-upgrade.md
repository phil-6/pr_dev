...
short-title: ryalto--needs-an-upgrade
full-title: Ryalto needs an Upgrade
summary: A detailed analysis of the options for upgrading or rebuilding the Ryalto back end.
file-type: md
...
## **We now have a planning document for the rebuild.** [**V4 Planning Document**](https://docs.google.com/document/d/11qyo7sxP57VPy_nH0nITXKJ-0zcNVHk4g8ZRar34zow/edit?usp=sharing)
...
Allow each organization to have a setting to select API Version
